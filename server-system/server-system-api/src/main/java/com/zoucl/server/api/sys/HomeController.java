...
import com.zoucl.server.utils.ResultCode;
...
public class HomeController extends BaseController {
    ...
    public Result getUserDetailInfo(){
        ...
        if(user1 != null){
            if(Validator.notEmpty(user1.getDeptId())){
                SysDept dept = new SysDept();
                dept.setId(user1.getDeptId());
                dept = sysDeptService.findDataById(dept);
                user1.setDepart(dept);
            }
